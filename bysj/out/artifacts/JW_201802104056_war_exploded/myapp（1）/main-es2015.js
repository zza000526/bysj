...
let ProfTitleComponent = class ProfTitleComponent {
    ...
    delete(profTitle) {
        ...
        this.schoolService.deleteProfTitle(profTitle).subscribe(res => alert(res.message));
    }
};
...
let AddTeacherComponent = class AddTeacherComponent {
    ...
    getDepartment() {
        this.teacherService.getDepartments().subscribe(res => this.departments = res);
    }
    getProfTitle() {
        this.teacherService.getProfTitles().subscribe(res => this.profTitles = res);
    }
    getDegree() {
        this.teacherService.getDegrees().subscribe(res => this.degrees = res);
    }
